...
graph_path = "./graph/extractor.pbtxt"
vocab_path = "/data/qwwang/bert/bert-utils/chinese_wwm_ext_L-12_H-768_A-12/vocab.txt"
...
obj = BERTFeatureExtractor(graph_path, vocab_path)

if __name__ == "__main__":
   print(obj.encode("今天天气不错")[0][:30])
   print(obj.encode("今天天气")[0][:30])
   print(obj.encode(["今天天气"] * 32))
